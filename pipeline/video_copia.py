...
def json_to_ass(src, dst):
    ...
    data_eng = json.load(open(src.replace("transcription", "sentences_translation"), encoding="utf-8"))
    ...
    with open(dst, "w", encoding="utf-8") as f:
        ...
        for seg in data["segments"]:
            ...
            for dic in data_eng: 
                if dic['text_chin'] == seg['text']:
                    translation = dic['text_eng']

                    line = "".join(tokens) + r"\N" + translation
                    break
            f.write(
